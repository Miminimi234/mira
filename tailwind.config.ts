  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'trade-up-soft': 'hsl(var(--trade-up-soft) / 0.16)',
        'trade-down': 'hsl(var(--trade-down))',
        'trade-down-soft': 'hsl(var(--trade-down-soft) / 0.16)',
        'trade-other': 'hsl(var(--trade-other))',
        'trade-other-soft': 'hsl(var(--trade-other-soft) / 0.16)',
